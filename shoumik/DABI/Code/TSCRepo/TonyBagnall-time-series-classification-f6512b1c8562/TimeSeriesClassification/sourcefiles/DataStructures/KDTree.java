...
//If you want highest priority items kept, negate your values
   ...
   {
	   Euclidean<Integer> kdTree = new Euclidean<Integer>(2);
	   kdTree.addPoint(new double[]{1,1}, 1);
	   kdTree.addPoint(new double[]{2,1}, 1);
	   kdTree.addPoint(new double[]{3,1}, 1);
	   kdTree.addPoint(new double[]{1,3}, 0);
	   kdTree.addPoint(new double[]{2,2}, 0);
	   kdTree.addPoint(new double[]{3,3}, 0);
	   
	   ArrayList<SearchResult<Integer>> neighbor = kdTree.nearestNeighbours(new double[]{5,2}, 1);
	   
	   kdTree.size();
	   
	   System.out.println( neighbor.get(0).distance + " " + neighbor.get(0).payload );
