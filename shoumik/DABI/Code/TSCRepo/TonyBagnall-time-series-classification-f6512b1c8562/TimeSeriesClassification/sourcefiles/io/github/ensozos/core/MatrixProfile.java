...
public class MatrixProfile {
    ...
    int window = 4;
    INDArray target = Nd4j.create(new double[]{0.0, 6.0, -1.0, 2.0, 3.0, 1.0, 4.0});
    INDArray query = Nd4j.create(new double[]{1.0, 2.0, 0.0, 0.0, -1});
    //matrixProfile.stamp(target, query, window);
    matrixProfile.stmp(target, query, window);
    }
